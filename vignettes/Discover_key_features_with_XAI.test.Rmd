...
se_path <- system.file("extdata", "seClassif.rds", package="adverSCarial")
dataset_classif <- readDRS(se_path)
...
# df_path <- system.file("extdata", "dfClassif.txt", package="adverSCarial")
...
se_path <- system.file("extdata", "dfRegress.rds", package="adverSCarial")
dataset_regress <- readDRS(se_path)
...
# Example with a dataframe.
# df_path <- system.file("extdata", "dfRegress.txt", package="adverSCarial")
